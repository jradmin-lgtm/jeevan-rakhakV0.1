// Diagnostic harness — wraps the App import in a try/catch so a broken
// module-load (the kind of crash that produces grey-screen + 'app keeps
// stopping' on Android) renders a visible error UI instead of killing
// the process. Once we know what's wrong, we restore the standard
// `import App from './App'; registerRootComponent(App);` shape.
...
function ErrorApp() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Text, { style: styles.title }, "App import failed"),
      React.createElement(
        Text,
        { style: styles.sub },
        "Share this whole screen with the developer:"
      ),
      React.createElement(
        View,
        { style: styles.box },
