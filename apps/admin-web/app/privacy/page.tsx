  ...
  return (
    <article className="privacy">
      <header>
        ...
        <p className="meta">
          Effective: {EFFECTIVE_DATE} · Applies to the Jeevan Rakshak patient
          app, driver app, and operations dashboard.
        </p>
      </header>
      ...
      <section>
        <h2>1. Who we are</h2>
        <p>
          Jeevan Rakshak is an emergency ambulance dispatch service. This policy
          explains what personal data we collect from patients booking
          ambulances, drivers offering ambulance services, and operations staff
          using the dashboard; how we use it; who we share it with; and the
          rights you have over it.
        </p>
        <p>
          In this policy, &ldquo;we&rdquo;, &ldquo;us&rdquo;, and &ldquo;Jeevan
          Rakshak&rdquo; refer to the entity operating the service. If you have
          any question about this policy, write to us at{" "}
      ...
      <section>
        ...
        <p>We only collect what we need to dispatch an ambulance to you safely.</p>
      ...
      <section>
        ...
        <p>
          We do <strong>not</strong> sell your data. We share specific data
          with specific parties for the limited purposes below.
        </p>
        <ul>
          <li>
      ...
      <section>
        <h2>5. Where we store your data and for how long</h2>
        <p>
          Data is stored on managed servers in India (or the geographically
          nearest available region). Encryption in transit (TLS) is enforced
          on every connection between the app and our servers; the database
      ...
      <section>
        <h2>7. Children</h2>
        <p>
          The Jeevan Rakshak apps are not directed at children under the age of
          18. A parent or guardian must book the ambulance on behalf of a
          minor. If we learn we have collected data from a child without
          parental consent, we delete it.
        </p>
      </section>
      ...
      <section>
        <h2>9. Security</h2>
        <p>
          We protect data with rate limiting, brute-force lockouts on
          authentication, JWT-based session tokens (30-day life), role-based
          access controls, encrypted transit and storage, and IP-restricted
          admin access. Despite best efforts, no service is perfectly secure.
          If you suspect a security issue, contact{" "}
      ...
      <section>
        ...
        <p>
          ...
          will be notified in the app at next sign-in. Continued use of the
      ...
      <footer>
        <p className="meta">
          Last updated {EFFECTIVE_DATE}. This document is hosted by Jeevan
          Rakshak and accessible at the path <code>/privacy</code>.
        </p>
      </footer>
      ...
      <style>{`
        ...
        .privacy h3 { font-size: 16px; margin: 20px 0 6px; color: #334155; }
        .privacy ul { padding-left: 22px; }
        .privacy li { margin: 6px 0; }
        .privacy a { color: #E5322B; text-decoration: underline; }
        .privacy code { background: #F1F5F9; padding: 1px 6px; border-radius: 4px; font-size: 13px; }
        .privacy .meta { color: #64748B; font-size: 14px; margin: 4px 0 0; }
        .privacy header { margin-bottom: 16px; }
        .privacy footer { margin-top: 40px; border-top: 1px solid #E2E8F0; padding-top: 16px; }
      `}</style>
    </article>
  );
}
