...
export function NameCaptureScreen({ initialName, onSaved }: Props) {
  ...
  return (
    <Screen>
      <AppHeader title="What should we call you?" subtitle="So patients can identify their ambulance driver" />
      ...
      <Text variant="tiny" tone="muted" align="center">
        Your name is shared only with the patients and our operations team.
      </Text>
    </Screen>
  );
}
